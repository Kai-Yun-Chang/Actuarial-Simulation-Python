# Monte Carlo Simulation for Insurance Loss-Python
📌 Project Overview
...
2. Monte Carlo Simulation
    ...
    * Generated aggregate losses: $S = \sum_{i=1}^{n} X_i$  (where: $𝑁$: number of claims $X_i$: claim severity after applying contract structure)
